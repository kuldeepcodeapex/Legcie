...
const ReadyBook = () => {
  ...
  const { setGetUserdata, fetchRasidents, dataR, setdataR, getuserdata, userCount, establishmentid, setRasidents, rasidents }: any = useAuth()
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              ...
              return (
                ...
                <View style={{ backgroundColor: "white", marginTop: 30, gap: 10, width: "100%", borderWidth: 0.1, borderLeftWidth: 5, borderColor: (item.Status === "waiting") ? "rgb(247, 186, 0)" : (item.Status === "Completed") ? "rgb(34, 197, 94)" : "red", borderRadius: 10, padding: 18 }}>
                  <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between" }}>
                    ...
                    {(item.Status==="waiting")?
                      <View style={{ flexDirection: "row", alignItems: "center", width: "20%", height: 60, paddingHorizontal: 10, paddingVertical: 1, borderRadius: 20, backgroundColor: "rgb(240, 192, 35)" }}>
                      ...
                      : <View style={{ flexDirection: "row", alignItems: "center", width: "20%", height: 60, paddingHorizontal: 10, paddingVertical: 1, borderRadius: 20, backgroundColor: "rgb(236, 22, 22)" }}>
                       
                        <Text style={{ color: "rgb(247, 186, 0)" }}>
                           waiting sometime
                        </Text>
                      </View>
                    }
