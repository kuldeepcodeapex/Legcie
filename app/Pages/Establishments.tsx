...
const Establishments = ({item}:any) => {
  ...
  const {establishmentid,setEstablishmentid}: any = useAuth()
      ...
      <View style={{borderRadius:10,shadowOpacity:10 }}>
          ...
          <View style={styles.centeredView2}>
            ...
            <UpdateEstablishments setModal={setModal}/>
                 ...
                 <Pressable style={{ flexDirection: "row",borderBottomLeftRadius:10,borderBottomRightRadius:10, gap: 10,backgroundColor: "rgb(255, 254, 248)", 
